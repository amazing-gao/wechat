...
import (
	...
	officialJs "github.com/amazing-gao/wechat/v2/officialaccount/js"
...
// NewJs init
func NewJs(context *context.Context, server, appID string) *Js {
	js := new(Js)
	js.Context = context
	jsTicketHandle := credential.NewDefaultJsTicket(server, appID, credential.CacheKeyOfficialAccountPrefix, context.Cache)
